...
- [NC Issues](#nc-issues)
  ...
  - [NC-5: Internal functions called only once can be inlined](#nc-5-internal-functions-called-only-once-can-be-inlined)
...
## NC-5: Internal functions called only once can be inlined
